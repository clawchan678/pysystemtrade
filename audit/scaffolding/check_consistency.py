...
chk("CSV: R01,R05,R08,R09,P09 at last_phase 15 (E02 moved on to 16 in Phase 16)", sorted(r["component_id"].split("_")[0] for r in rows if r["last_phase"]=="15")==["P09","R01","R05","R08","R09"])
