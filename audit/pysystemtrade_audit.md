...
Status: **P0 complete (Phases 1–8, all approved). P1A in progress: Phases 11, 12 and 9 complete, and Phase 14 complete** (Phases 11–12 session 5, approved; Phases 9 and 14 session 6). Next: Phase 13. Phase 10 is ON HOLD (operator decision).
